...
package co.abrtech.game.sdksample.util;
...
public class IabHelper {
    ...
    // Intent action
    private static final String BIND_ACTION = "co.abrstudio.game.iab.service.action.BIND";
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
        ...
        Intent serviceIntent = new Intent(BIND_ACTION);
